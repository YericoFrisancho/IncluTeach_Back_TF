...
public class UsuarioService {
    ...
    public List<UsuarioDTO> filtrarPorRol(String rol) {
        List<Usuario> lista = usuarioRepository.findByRolNombreIgnoreCase(rol);
    ...
    public List<Map<String, Object>> obtenerEstadisticasRoles() {
        return usuarioRepository.obtenerEstadisticasRoles();
    }
    public List<Map<String, Object>> obtenerDistribucionRoles() {
        return usuarioRepository.obtenerDistribucionRoles();
    }
}